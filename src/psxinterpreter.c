...
static void psxJumpTest(void) {
	if (!Config.HLE) {
		uint32_t call = psxRegs.GPR.n.t1 & 0xff;
...
static uint32_t psxBranchNoDelay(void) {
	...
	code = (uint32_t *)PSXM(psxRegs.pc);
	psxRegs.code = ((code == NULL) ? 0 : SWAP32(*code));
	switch (_Op_) {
		case 0x00: // SPECIAL
			switch (_Funct_) {
				case 0x08: // JR
					return _uint32_t(_rRs_);
				case 0x09: // JALR
					temp = _uint32_t(_rRs_);
...
static void doBranch(uint32_t tar) {
	uint32_t *code;
	uint32_t tmp;
...
*********************************************************/
void psxADDI(void) 	{ if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) + _Imm_ ; }		// Rt = Rs + Im 	(Exception on Integer Overflow)
void psxADDIU(void) { if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) + _Imm_ ; }		// Rt = Rs + Im
void psxANDI(void) 	{ if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) & _ImmU_; }		// Rt = Rs And Im
void psxORI(void) 	{ if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) | _ImmU_; }		// Rt = Rs Or  Im
void psxXORI(void) 	{ if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) ^ _ImmU_; }		// Rt = Rs Xor Im
void psxSLTI(void) 	{ if (!_Rt_) return; _rRt_ = _i32(_rRs_) < _Imm_ ; }		// Rt = Rs < Im		(Signed)
void psxSLTIU(void) { if (!_Rt_) return; _rRt_ = _uint32_t(_rRs_) < ((uint32_t)_Imm_); }		// Rt = Rs < Im		(Unsigned)

/*********************************************************
* Register arithmetic                                    *
* Format:  OP rd, rs, rt                                 *
*********************************************************/
void psxADD(void)	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) + _uint32_t(_rRt_); }	// Rd = Rs + Rt		(Exception on Integer Overflow)
void psxADDU(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) + _uint32_t(_rRt_); }	// Rd = Rs + Rt
void psxSUB(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) - _uint32_t(_rRt_); }	// Rd = Rs - Rt		(Exception on Integer Overflow)
void psxSUBU(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) - _uint32_t(_rRt_); }	// Rd = Rs - Rt
void psxAND(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) & _uint32_t(_rRt_); }	// Rd = Rs And Rt
void psxOR(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) | _uint32_t(_rRt_); }	// Rd = Rs Or  Rt
void psxXOR(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) ^ _uint32_t(_rRt_); }	// Rd = Rs Xor Rt
void psxNOR(void) 	{ if (!_Rd_) return; _rRd_ =~(_uint32_t(_rRs_) | _uint32_t(_rRt_)); }// Rd = Rs Nor Rt
void psxSLT(void) 	{ if (!_Rd_) return; _rRd_ = _i32(_rRs_) < _i32(_rRt_); }	// Rd = Rs < Rt		(Signed)
void psxSLTU(void) 	{ if (!_Rd_) return; _rRd_ = _uint32_t(_rRs_) < _uint32_t(_rRt_); }	// Rd = Rs < Rt		(Unsigned)
...
void psxMULT(void) {
	...
	psxRegs.GPR.n.lo = (uint32_t)(res & 0xffffffff);
	psxRegs.GPR.n.hi = (uint32_t)((res >> 32) & 0xffffffff);
}

void psxMULTU(void) {
	uint64_t res = (uint64_t)((uint64_t)_uint32_t(_rRs_) * (uint64_t)_uint32_t(_rRt_));
...
* Format:  OP rd, rt, sa                                 *
*********************************************************/
void psxSLL(void) { if (!_Rd_) return; _uint32_t(_rRd_) = _uint32_t(_rRt_) << _Sa_; } // Rd = Rt << sa
void psxSRA(void) { if (!_Rd_) return; _i32(_rRd_) = _i32(_rRt_) >> _Sa_; } // Rd = Rt >> sa (arithmetic)
void psxSRL(void) { if (!_Rd_) return; _uint32_t(_rRd_) = _uint32_t(_rRt_) >> _Sa_; } // Rd = Rt >> sa (logical)

/*********************************************************
* Shift arithmetic with variant register shift           *
* Format:  OP rd, rt, rs                                 *
*********************************************************/
void psxSLLV(void) { if (!_Rd_) return; _uint32_t(_rRd_) = _uint32_t(_rRt_) << _uint32_t(_rRs_); } // Rd = Rt << rs
void psxSRAV(void) { if (!_Rd_) return; _i32(_rRd_) = _i32(_rRt_) >> _uint32_t(_rRs_); } // Rd = Rt >> rs (arithmetic)
void psxSRLV(void) { if (!_Rd_) return; _uint32_t(_rRd_) = _uint32_t(_rRt_) >> _uint32_t(_rRs_); } // Rd = Rt >> rs (logical)

/*********************************************************
* Load higher 16 bits of the first word in GPR with imm  *
* Format:  OP rt, immediate                              *
*********************************************************/
void psxLUI(void) { if (!_Rt_) return; _uint32_t(_rRt_) = psxRegs.code << 16; } // Upper halfword of Rt = Im
...
*********************************************************/
void psxJR(void)   {
	doBranch(_uint32_t(_rRs_));
	psxJumpTest();
}

void psxJALR(void) {
	uint32_t temp = _uint32_t(_rRs_);
	if (_Rd_) { _SetLink(_Rd_); }
	doBranch(temp);
}
...
#define _oB_ (_uint32_t(_rRs_) + _Imm_)
...
void psxLBU(void) {
	if (_Rt_) {
		_uint32_t(_rRt_) = psxMemRead8(_oB_);
	} else {
		psxMemRead8(_oB_);
	}
}
...
void psxLHU(void) {
	if (_Rt_) {
		_uint32_t(_rRt_) = psxMemRead16(_oB_);
	} else {
		psxMemRead16(_oB_);
	}
}
...
void psxLW(void) {
	if (_Rt_) {
		_uint32_t(_rRt_) = psxMemRead32(_oB_);
	} else {
		psxMemRead32(_oB_);
	}
}

uint32_t LWL_MASK[4] = { 0xffffff, 0xffff, 0xff, 0 };
uint32_t LWL_SHIFT[4] = { 24, 16, 8, 0 };
...
void psxLWL(void) {
	...
	if (!_Rt_) return;
	_uint32_t(_rRt_) =	( _uint32_t(_rRt_) & LWL_MASK[shift]) |
					( mem << LWL_SHIFT[shift]);
...
uint32_t LWR_MASK[4] = { 0, 0xff000000, 0xffff0000, 0xffffff00 };
uint32_t LWR_SHIFT[4] = { 0, 8, 16, 24 };
...
void psxLWR(void) {
	...
	if (!_Rt_) return;
	_uint32_t(_rRt_) =	( _uint32_t(_rRt_) & LWR_MASK[shift]) |
					( mem >> LWR_SHIFT[shift]);
...
uint32_t SWL_MASK[4] = { 0xffffff00, 0xffff0000, 0xff000000, 0 };
uint32_t SWL_SHIFT[4] = { 24, 16, 8, 0 };
...
void psxSWL(void) {
	...
	psxMemWrite32(addr & ~3,  (_uint32_t(_rRt_) >> SWL_SHIFT[shift]) |
			     (  mem & SWL_MASK[shift]) );
	/*
	Mem = 1234.  Reg = abcd
...
uint32_t SWR_MASK[4] = { 0, 0xff, 0xffff, 0xffffff };
uint32_t SWR_SHIFT[4] = { 0, 8, 16, 24 };
...
void psxSWR(void) {
	...
	psxMemWrite32(addr & ~3,  (_uint32_t(_rRt_) << SWR_SHIFT[shift]) |
			     (  mem & SWR_MASK[shift]) );
...
void psxMTC0(void) { MTC0(_Rd_, _uint32_t(_rRt_)); }
void psxCTC0(void) { MTC0(_Rd_, _uint32_t(_rRt_)); }
